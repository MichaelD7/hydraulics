...
print("Test Run 2")
channel1.setValues(0.5, 0.8, 2, 100.0, 1.0, 0.9, 0.003, 1.141e-06, 0.4, True, "DWCW", 0, 0)
# print(channel1.critical_depth())
# print(channel1.normal_depth())
# crit_depth = channel1.critical_depth()
channel1.calculate()
...
print("Test Run 2 - manning")
channel1.setValues(0.5, 0.8, 2, 100.0, 1.0, 0.9, 0.015, 1.141e-06, 0.4, True, "MANNING", 0, 0)
# print(channel1.critical_depth())
# print(channel1.normal_depth())
# crit_depth = channel1.critical_depth()
channel1.calculate()
