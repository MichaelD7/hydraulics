...
print("Pipe Test Run 9")
pipe1 = Pipe()
pipe1.setValues(0.5, 1.0, 100.0, 1.0, 0.9, 0.003, 1.141e-06, 0.6, False, "DWCW", 0.5)
...
print("Test Run 10")
pipe1.setValues(0.5, 1.0, 100.0, 1.0, 0.9, 0.003, 1.141e-06, 1.2)
# print(channel1.critical_depth())
# print(channel1.normal_depth())
# crit_depth = channel1.critical_depth()
pipe1.calculate()
