...
channel1.setValues(1.0, 0.8, 1, 100.0, 1.0, 0.9, 0.003, 1.141e-06, 1.1, False, "DWCW", 0.5, 0.5)
...
print("Test Run 12")
channel1.setValues(0.5, 0.8, 2, 100.0, 1.0, 0.9, 0.003, 1.141e-06, 0.0, False, "DWCW", 1, 1)
# print(channel1.critical_depth())
# print(channel1.normal_depth())
# crit_depth = channel1.critical_depth()
channel1.calculate()
